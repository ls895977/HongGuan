    ...
    public class RedListItemAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (adapterType == 0) {
                ...
                redViewHolder.moneyTv.setText(df.format(reciveRedList.get(position).getMoney()) + "糖果");
                ...
                String StrTime = sdf.format(new Date(lcc_time * 1000L));
                redViewHolder.timeTv.setText(StrTime);
                redViewHolder.moneyTv.setText(df.format(sendRedList.get(position).getMoney()) + "糖果");
            }
            return convertView;
        }
