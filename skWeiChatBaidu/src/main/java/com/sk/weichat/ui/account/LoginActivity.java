...
import com.sk.weichat.video.CustomVideo;
...
public class LoginActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String videoPath = Uri.parse("android.resource://" + getPackageName() + "/" +R.raw.bg).toString();
    ...
    private void initView() {
        ...
        findViewById(R.id.img_register).setOnClickListener(this);
    }
