...
public class MyApplication extends Application {
    ...
    private void initUmeng() {
        UMConfigure.init(this, "5f44defdf9d1496ef418ab4d", "Umeng", UMConfigure.DEVICE_TYPE_PHONE, null);
    }
    ...
    private void setFaceConfig() {
        FaceSDKManager.getInstance().initialize(this, "yujianIm-face-android", "idl-license.face-android");
...
//                    }
                ...
                case SHOW_TOAST:  //需要弹出Toast
                    Toast.makeText(MyApplication.context, (String) msg.obj, Toast.LENGTH_SHORT).show();
                    break;
            }
