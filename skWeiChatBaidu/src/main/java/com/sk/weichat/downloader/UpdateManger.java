...
//            showNoticeDialog(getStringById(R.string.application_version_update_down), getStringById(R.string.application_update));
    ...
    protected void showTipDialog() {
       CustomDialog dialog = new CustomDialog(mContext, R.style.mytipstyle,
                R.layout.tipnewdialog);
    ...
    class CustomDialog extends Dialog implements
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            // 根据id在布局中找到控件对象
            bt_cancal = (ImageButton) findViewById(R.id.pt_cancal);
            bt_delect = (ImageButton) findViewById(R.id.pt_delect);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.pt_delect:
                    ...
                    dismiss();// 当取消对话框后进行操作一定的代码？取消对话框
                    try {
                        showDownloadDialog();
                    } catch (Throwable t) {
