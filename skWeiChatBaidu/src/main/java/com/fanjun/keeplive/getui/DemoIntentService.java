...
public class DemoIntentService extends GTIntentService {
    ...
    public void onReceiveMessageData(Context context, GTTransmitMessage msg) {
        ...
        if (payload == null) {
            ...
            sendMessage(data, MyApplication.GetuiHandler.RECEIVE_MESSAGE_DATA);
        }
    ...
    public void onReceiveClientId(Context context, String clientid) {
        ...
        // 保存clientid
        sharedPreferences = getSharedPreferences("mypd",Context.MODE_PRIVATE);
        ...
        sendMessage(clientid, MyApplication.GetuiHandler.RECEIVE_CLIENT_ID);
    }

    @Override
    public void onReceiveOnlineState(Context context, boolean online) {
        Log.d(TAG, "onReceiveOnlineState -> " + (online ? "online" : "offline"));
        sendMessage(String.valueOf(online), MyApplication.GetuiHandler.RECEIVE_ONLINE_STATE);
    }
    ...
    private void setTagResult(SetTagCmdMessage setTagCmdMsg) {
        ...
        sendMessage(getResources().getString(text), MyApplication.GetuiHandler.SHOW_TOAST);
    ...
    public void onReceiveDeviceToken(Context context, String s) {
        super.onReceiveDeviceToken(context, s);
        Log.e("DeviceToken",s);
    }
}
