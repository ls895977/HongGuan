...
public class SelectProgramThemeDialog extends Dialog {
    ...
    void onClick(View view) {
        switch (view.getId()) {
            case R.id.iv_ktv:
                ReleaseProgramActivity.startActivity(getContext(), "唱歌");
                break;
            case R.id.iv_travel:
                ReleaseProgramActivity.startActivity(getContext(), "应酬");
                break;
            case R.id.iv_movie:
                ReleaseProgramActivity.startActivity(getContext(), "健身");
                break;
            case R.id.iv_food:
                ReleaseProgramActivity.startActivity(getContext(), "美食");
                break;
            case R.id.iv_game:
                ReleaseProgramActivity.startActivity(getContext(), "游戏");
                break;
            case R.id.iv_close:
                break;
        }
