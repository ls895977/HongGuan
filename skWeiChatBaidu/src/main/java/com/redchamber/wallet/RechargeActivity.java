...
public class RechargeActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        URL = String.format("http://api.bao.0575yw.com/pages/hgH5pay/index.html#/?userId=%s&sex=%s", coreManager.getSelf().getUserId(), coreManager.getSelf().getSex());
        Log.i("aaa", "链接：" + URL);
