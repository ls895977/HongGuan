...
public class AccountLoginActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void login() {
        ...
        //    特殊登录
        Boolean num1 = phoneNumber.equals("18629678783") && password.equals("123456");
//        Boolean num2 = phoneNumber.equals("13476771774") && password.equals("123456");
        if (num1  ){
            jump();
            return;
        }
    ...
    private void jump() {
        ...
        if (1 == mUserStatus) {
            ...
            //去补填邀请码，或者开通vip
            NewAAActivity.startActivity(mContext, InvitationCodeActivity.TYPE_REGISTERED_NO_CODE);
        }
        finish();
    }
...
//                    Toast.makeText(AccountLoginActivity.this,String.valueOf(beauty),Toast.LENGTH_SHORT).show();
    ...
    private void sendFaceBeauty(int beauty){


            HashMap<String, String> params = new HashMap<String, String>();
            params.put("access_token", coreManager.getSelfStatus().accessToken);
            params.put("userId", coreManager.getSelf().getUserId());
            params.put("beautyScore",String.valueOf(beauty));
            HttpUtils.post().url(coreManager.getInstance(this).getConfig().FACE_BEAUTE)
                    .params(params)
                    .build()
...
//                                Toast.makeText(AccountLoginActivity.this,"颜值发送成功",Toast.LENGTH_SHORT).show();
