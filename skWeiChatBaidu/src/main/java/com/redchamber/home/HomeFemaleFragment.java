...
public class HomeFemaleFragment extends BaseFragment {
    ...
    private String mProvinceName = "上海市";
    ...
    void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_location:
                ...
                selectAreaDialog.setOnConfirmListener((city, province) -> {
                    mCityName = city;
    ...
    private void updateUserList() {
        mNearFragment.getNearIndexUser(mIsOnline, mCityName, mProvinceName);
        mNewerFragment.getNewerIndexUser(mIsOnline, mCityName, mProvinceName);
        mGirlFragment.getGirlIndexUser(mIsOnline, mCityName, mProvinceName);
        mDebutanteFragment.getDebutanteIndexUser(mIsOnline, mCityName, mProvinceName);
    }
