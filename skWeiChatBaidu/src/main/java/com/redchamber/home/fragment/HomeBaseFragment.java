...
public class HomeBaseFragment extends BaseFragment {
    ...
    protected void initView() {
        ...
        getIndexUser(mOnlineFirst, mCityName, mProvinceName);
    }
    ...
    private void initRefreshLayout() {
        ...
        mRefreshLayout.setOnLoadMoreListener(refreshLayout -> getIndexUser(mOnlineFirst, mCityName, mProvinceName));
    }

    private void getIndexUser(String onlineFirst, String cityName, String provinceName) {
    ...
    public void onMessageEvent(UpdateCityOnlineEvent event) {
        if (event != null) {
            ...
            mProvinceName = event.provinceName;
            pageIndex = 1;
            getIndexUser(event.onlineFirst, event.cityName, mProvinceName);
        }
    }
