...
//                startActivity(new Intent(getContext(), LoginHistoryActivity.class));
    ...
    void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.tv_release:
                ...
                break;
            case R.id.iv_ktv:
                AppointmentComActivity.startActivity(getContext(), "唱歌");
                break;
            case R.id.iv_travel:
                AppointmentComActivity.startActivity(getContext(), "应酬");
                break;
            case R.id.iv_movie:
                AppointmentComActivity.startActivity(getContext(), "健身");
                break;
            case R.id.iv_food:
                AppointmentComActivity.startActivity(getContext(), "美食");
                break;
            case R.id.iv_game:
                AppointmentComActivity.startActivity(getContext(), "游戏");
    ...
    private void VipOrPay(QueryFreeAuthBean queryFreeAuthBean, int resultCode) {
        ...
        ReleaseCodeDialog commCodeDialog = new ReleaseCodeDialog(getContext(), "发布动态或节目", "支付" + queryFreeAuthBean.getPrice() + "糖果", "会员免费发布"+queryFreeAuthBean.getVipSumTimes()+"次");
        commCodeDialog.show();
        commCodeDialog.setOnConfirmListener(new ReleaseCodeDialog.OnConfirmListener() {
            @Override
            public void onConfirmClick(int type) {
    ...
    private void payRed(QueryFreeAuthBean queryFreeAuthBean, int resultCode) {
        CommCodeDialog commCodeDialog = new CommCodeDialog(getContext(), "次数已用完", "支付" + queryFreeAuthBean.getPrice() + "糖果");
        commCodeDialog.show();
        commCodeDialog.setOnConfirmListener(new CommCodeDialog.OnConfirmListener() {
            @Override
            public void onConfirmClick() {
