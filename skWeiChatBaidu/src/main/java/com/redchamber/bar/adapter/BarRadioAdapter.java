...
public class BarRadioAdapter extends BaseMultiItemQuickAdapter<PageDataBean, BaseViewHolder> {
    ...
    protected void convert(@NonNull BaseViewHolder helper, PageDataBean item) {
        switch (helper.getItemViewType()) {
            case PageDataBean.TYPE_A:
                ...
                */
                ...
                if (item.getLikeNum()>0){
                    viewHolderA.tvRadioDianzan.setTextColor(mContext.getResources().getColor(R.color.color_FB719A));
                    viewHolderA.img_dainzam.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.yl_dz));

                }else{
                    viewHolderA.img_dainzam.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.yj_dz_un));
                    viewHolderA.tvRadioDianzan.setTextColor(mContext.getResources().getColor(R.color.text_333));
                }
                viewHolderA.tvRadioDianzan.setText(item.getLikeNum() == 0 ? "点赞" : String.valueOf(item.getLikeNum()));


                if (item.getSignUpNums()>0){
                    viewHolderA.tvRadioApply.setTextColor(mContext.getResources().getColor(R.color.color_FB719A));
                    viewHolderA.img_bm.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.yj_bm));

                }else{
                    viewHolderA.tvRadioApply.setTextColor(mContext.getResources().getColor(R.color.text_333));
                    viewHolderA.img_bm.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.yj_bm_un));
                }
                ...
                if (item.getDiscussFlag() == 1) {
                    ...
                    if (item.getDiscussNum()>0){
                        viewHolderA.tvRadioComm.setTextColor(mContext.getResources().getColor(R.color.color_FB719A));
                        viewHolderA.img_pl.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.yj_pl));
                    }else{
                        viewHolderA.tvRadioComm.setTextColor(mContext.getResources().getColor(R.color.text_333));
                        viewHolderA.img_pl.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.yj_pl_un));
                    }
                ...
                if (item.getProgramFlag() == 0) {
                    viewHolderA.img_bm.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.yj_bmjs));
            ...
            case PageDataBean.TYPE_B:
                ...
                if (item.getLikeNum()>0){
                    viewHolderB.tvRadioDianzan.setTextColor(mContext.getResources().getColor(R.color.color_FB719A));
                    viewHolderB.img_dainzam.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.yl_dz));

                }else{
                    viewHolderB.img_dainzam.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.yj_dz_un));
                    viewHolderB.tvRadioDianzan.setTextColor(mContext.getResources().getColor(R.color.text_333));
                }
                ...
                if (item.getDiscussFlag() == 1) {
                    ...
                    if (item.getDiscussNum()>0){
                        viewHolderB.tvRadioComm.setTextColor(mContext.getResources().getColor(R.color.color_FB719A));
                        viewHolderB.img_pl.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.yj_pl));
                    }else{
                        viewHolderB.tvRadioComm.setTextColor(mContext.getResources().getColor(R.color.text_333));
                        viewHolderB.img_pl.setImageDrawable(mContext.getResources().getDrawable(R.mipmap.yj_pl_un));
                    }
    ...
    static class RadioAViewHolder extends BaseViewHolder {
        ...
        ImageView img_pl;
        @BindView(R.id.img_dainzam)
        ImageView img_dainzam;
        @BindView(R.id.img_bm)
        ImageView img_bm;
