...
//        mSwipeLayout.setRefreshing(false);
    ...
    private void VipOrPay(QueryFreeAuthBean queryFreeAuthBean, int resultCode) {
        ...
        ReleaseCodeDialog commCodeDialog = new ReleaseCodeDialog(AppointmentComActivity.this, "发布动态或节目", "支付" + queryFreeAuthBean.getPrice() + "糖果", "会员免费发布"+queryFreeAuthBean.getVipSumTimes()+"次");
        commCodeDialog.show();
        commCodeDialog.setOnConfirmListener(new ReleaseCodeDialog.OnConfirmListener() {
            @Override
            public void onConfirmClick(int type) {
    ...
    private void payRed(QueryFreeAuthBean queryFreeAuthBean, int resultCode) {
        CommCodeDialog commCodeDialog = new CommCodeDialog(AppointmentComActivity.this, "次数已用完", "支付" + queryFreeAuthBean.getPrice() + "糖果");
        commCodeDialog.show();
        commCodeDialog.setOnConfirmListener(new CommCodeDialog.OnConfirmListener() {
            @Override
            public void onConfirmClick() {
